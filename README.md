# Magento 2.0.14 Enterprise Cloud Edition

This sample repository helps you deploy a Magento 2.0.14 Enterprise Edition (EE) instance in the cloud. You must be a licensed user of Magento Enterprise Cloud Edition to use the example in this repository.
...
```
 ...
    "require": {
        "magento/magento-cloud-metapackage": "2.0.14",
    },
 ...
```
