...
namespace Magento\Staging\Test\Block\Adminhtml\Product\Edit\Section;
 ...
 */
class StagingAdvancedPricing extends Section
{
    /**
     ...
     * @var string
     */
    protected $advancedPricingRootElement =
        '.catalogstaging_update_form_catalogstaging_update_form_advanced_pricing_modal';
