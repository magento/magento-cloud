...
{
    /**
     * @var \Magento\Solr\SearchAdapter\Adapter
     */
    private $adapter;
    ...
    protected function setUp()
    {
        ...
        $this->adapter = $this->objectManager->create('Magento\Solr\SearchAdapter\Adapter');
    }
     ...
     * @magentoDataFixture Magento/Solr/SearchAdapter/_files/products.php
     */
